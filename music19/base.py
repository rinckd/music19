...
# -----------------------------------------------------------------------------
'''
`music21.base` is what you get in `music21` if you type ``import music19``. It
...
from music19._version import __version__, __version_info__
from music19 import common
from music19.common.enums import ElementSearch, OffsetSpecial
from music19.common.numberTools import opFrac
from music19.common.types import OffsetQL, OffsetQLIn
from music19 import defaults
from music19.derivation import Derivation
from music19.duration import Duration, DurationException
from music19.editorial import Editorial  # import class directly to not conflict with property.
from music19 import environment
from music19 import exceptions21
from music19 import prebase
from music19.sites import Sites, SitesException, WEAKREF_ACTIVE
from music19.style import Style
from music19.sorting import SortTuple, ZeroSortTupleLow, ZeroSortTupleHigh
...
class Music21Object(prebase.ProtoM21Object):
    ...
    **Equality**
    ...
    def _getMeasureOffset(self, includeMeasurePadding=True) -> float|fractions.Fraction:
        ...
        [0.0, 0.5, 1.0, 1.5]
        '''
        # Check for cached measureOffset value first (used by corpus bridge)
        if hasattr(self, '_cached_measureOffset') and includeMeasurePadding:
            return self._cached_measureOffset
    ...
    def beat(self) -> fractions.Fraction|float:
        ...
        * Changed in v6.3: returns `nan` if
        ...
        '''
        # Check for cached beat value first (used by corpus bridge)
        if hasattr(self, '_cached_beat'):
            return self._cached_beat
    ...
    def beatDuration(self) -> Duration:
        ...
        * Changed in v6.3: returns a duration.Duration object of length 0 if
        ...
        '''
        # Check for cached beatDuration value first (used by corpus bridge)
        if hasattr(self, '_cached_beatDuration'):
            return Duration(quarterLength=self._cached_beatDuration)
    ...
    def beatStrength(self) -> float:
        ...
        * Changed in v6.3: return 'nan' instead of raising an exception.
        '''
        # Check for cached beatStrength value first (used by corpus bridge)
        if hasattr(self, '_cached_beatStrength'):
            return self._cached_beatStrength
...
class Test(unittest.TestCase):
    ...
    def testCopyAndDeepcopy(self):
        from music19.test.commonTest import testCopyAll
...
if __name__ == '__main__':
    import music19
    music19.mainTest()  # , runTest='testPreviousB')
