...
from music19.converter import subConverters
from music19.converter import museScore

from music19 import _version
...
from music19.metadata import bundles
...
class TestSlow(unittest.TestCase):  # pragma: no cover
    ...
    def testMusicXMLConversion(self):
        try:
            ...
            testFiles = external_music21.musicxml.testFiles
        except ImportError:
...
if __name__ == '__main__':
    ...
    import music19
    music19.mainTest(Test)  # , runTest='testConverterFromPath')
