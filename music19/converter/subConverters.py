...
from music19.exceptions21 import SubConverterException
...
class ConverterIPython(SubConverter):
    ...
    def show(self, obj, fmt, app=None, subformats=(),
        ...
        '''
        from music19.converter import Converter
        from music19.ipython21 import converters as ip21_converters
    ...
    def parseData(self, tnData, number=None):
        ...
        if isinstance(tnData, str):
            ...
            raise SubConverterException(
                ...
                + 'in the stream')
        from music19 import tinyNotation
...
class ConverterMusicXML(SubConverter):
    ...
    def parseData(self, xmlString: str, number=None):
        ...
        '''
        raise RuntimeError(
            "MusicXML functionality has been removed from music19. "
            "Please install the full music21 package for MusicXML support: pip install music21"
        )
    ...
    def writeDataStream(self,
        ...
        * Changed in v7: returns a pathlib.Path
        ...
        >>> import os
        >>> from music19.converter.subConverters import ConverterMusicXML
        >>> fp = 'noSuffix'
...
class Test(unittest.TestCase):
    ...
    def testWriteMXL(self):
        ...
        try:
            import music19 as external_music21
            # Use external music21 for test data
            testPrimitive = external_music21.musicxml.testPrimitive
        except ImportError:
            self.skipTest("Requires music21 package for MusicXML test data")
    ...
    def testWriteMusicXMLMakeNotation(self):
        ...
        try:
            import music19 as external_music21
            # Use external music21 for MusicXML exceptions
            MusicXMLExportException = external_music21.musicxml.xmlObjects.MusicXMLExportException
        except ImportError:
            self.skipTest("Requires music21 package for MusicXML functionality")
...
class TestExternal(unittest.TestCase):
    ...
    #      '''
    #     from music19 import stream, note
