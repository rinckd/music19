...
from music19.metadata.bundles import MetadataEntry
...
def allFeaturesAsList(streamInput):
    ...
    True
    '''
    from music19.features import jSymbolic, native
...
class Test(unittest.TestCase):
 ...
 {'durationSeconds': 0.5,
  ...
  'voiceIndex': None}]''', pformat(di['secondsMap']))
    ...
    #     from music19.features.base import _pickleFunctionNumPitches
    #     import textwrap
    #
    #     self.maxDiff = None
    #
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , runTest='testStreamFormsA')
