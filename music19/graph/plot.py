...
from music19 import features
from music19 import note
from music19 import prebase
from music19 import stream  # circular, but okay, because not used at top level.

from music19.graph import axis
from music19.graph import primitives
from music19.graph.utilities import (GraphException, PlotStreamException)
...
class PlotStreamMixin(prebase.ProtoM21Object):
    ...
    def run(self, *, callProcess: bool = True, **keywords):
        ...
        '''
        if t.TYPE_CHECKING:
            from music19.graph.primitives import Graph
...
class Plot3DBarsPitchSpaceQuarterLength(Plot3DBars):
    ...
    >>> #_DOCS_SHOW from music19.musicxml import testFiles
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , TestExternalManual)
