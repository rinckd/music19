...
from music19.base import _missingImport
...
def getExtendedModules():
    ...
    in ``from music19 import *`` unless it's actually needed.
...
if __name__ == '__main__':
    ...
    import music19
    music19.mainTest(Test)  # TestExternal, 'noDocTest') #, runTest='testGetPlotsToMakeA')
