...
class NoChord(ChordSymbol):
    ...
    >>> from music19.harmony import ChordSymbol, NoChord
    >>> s = stream.Score()
...
class TestExternal(unittest.TestCase):
    ...
    #     possible).
    #     '''
    #     from music19.alpha.theoryAnalysis import theoryAnalyzer
    #     from music19 import harmony, corpus
    #
    #     score = corpus.parse('bach/bwv380')
    #     excerpt = score.measures(2, 3)
    #
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , runTest='testChordStepBass')
