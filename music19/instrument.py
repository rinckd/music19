...
from music19.exceptions21 import InstrumentException
from music19 import interval
from music19 import note
from music19 import pitch
from music19.tree.trees import OffsetTree
...
def deduplicate(s: stream.Stream, inPlace: bool = False) -> stream.Stream:
    ...
    >>> from music19.stream import Score, Part
...
def fromString(instrumentString: str,
    ...
    '''
    from music19.languageExcerpts import instrumentLookup
    ...
    this_module = importlib.import_module('music19.instrument')
...
class Test(unittest.TestCase):
    ...
    #     '''
    #     from music19 import instrument, converter, stream
    #     p1 = converter.parse("tinynotation: 4/4 c4  d  e  f  g  a  b  c'  c1")
    #     p2 = converter.parse("tinynotation: 4/4 C#4 D# E# F# G# A# B# c#  C#1")
    #
    #     p1.getElementsByClass(stream.Measure)[0].insert(0.0, instrument.Piccolo())
