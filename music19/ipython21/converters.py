...
# from music19.ipython21.ipExtension import needsToLoadRequireJS

if t.TYPE_CHECKING:
    from music19 import base
    from music19.converter.subConverters import SubConverter, ConverterMidi
...
def displayMusic21jMIDI(
    ...
    **keywords,
    ...
    #     '''
    #     import random
    #     from music19.vexflow import toMusic21j
