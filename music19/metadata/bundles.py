...
from music19.common.fileTools import readPickleGzip
...
if t.TYPE_CHECKING:
    ...
    from music19.metadata import Metadata
...
class MetadataBundle(prebase.ProtoM21Object):
    ...
    def corpus(self):
        ...
        from music19.corpus import manager
    ...
    def listSearchFields():
        ...
        from music19.metadata import RichMetadata
        return tuple(sorted(
    ...
    def search(
        ...
        **keywords
        ...
        from music19.corpus.corpora import Corpus
...
def demo_bundle(which: str):
    ...
    if which == 'core':
        from music19.corpus.corpora import CoreCorpus
