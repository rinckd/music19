...
from music19.common.enums import ContainsEnum
...
class MidiEvent(prebase.ProtoM21Object):
    ...
    def getBytes(self) -> bytes:
        r'''
        Return a set of bytes for this MIDI event (used for translating from music19 to MIDI)
...
class MidiTrack(prebase.ProtoM21Object):
    ...
    def getBytes(self) -> bytes:
        ...
        For conversion from music19 to MIDI.
