...
from music19.common.types import OffsetQL
...
class Ottava(Spanner):
    ...
    def interval(self, reverse=False):
        ...
        '''
        from music19.interval import Interval
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        from music19.musicxml.m21ToXml import GeneralObjectExporter
    ...
    def testOttavaShiftA(self):
        ...
        from music19.spanner import Ottava   # need to do it this way for classSet
        s = stream.Stream()
    ...
    #     from music19 import stream, note, spanner, chord, dynamics
    #     s = stream.Stream()
    #     s.repeatAppend(note.Note(), 12)
    #     for i, n in enumerate(s.notes):
    #         n.transpose(i + (i % 2 * 12), inPlace=True)
    ...
    def testOneElementSpanners(self):
        from music19 import note
        from music19.spanner import Spanner
    ...
    def testRemoveSpanners(self):
        from music19 import stream
        from music19 import note
        from music19.spanner import Spanner, Slur
    ...
    def testFreezeSpanners(self):
        ...
        from music19.spanner import Slur
