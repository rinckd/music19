...
from music19.common.enums import GatherSpanners, OffsetSpecial
...
from music19 import derivation
...
from music19.stream.enums import GivenElementsBehavior, RecursionType, ShowNumber
...
class Stream(core.StreamCore, t.Generic[M21ObjType]):
    ...
    * New in v7: providing a single element now works:
    ...
    >>> from music19.stream.enums import GivenElementsBehavior
    ...
    * New in v8: givenElementsBehavior keyword configures the smart appending.
    ...
    def _replaceSpannerBundleForDeepcopy(self, new):
        ...
        for e in new.recurse(includeSelf=False):
            ...
            if 'music19.spanner.Spanner' in e.classSet:
                continue
    ...
    def measures(
        ...
        *,
        ...
        >>> from music19.common.enums import GatherSpanners
    ...
    def getInstruments(self,
        ...
        * Changed in v8: recurse is True by default.
        ...
        if returnDefault and instObj is None:
            from music19.instrument import Instrument
            instObj = Instrument()
