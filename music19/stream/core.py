...
from music19.base import Music21Object
from music19.common.enums import OffsetSpecial
from music19.common.numberTools import opFrac
from music19.common.types import OffsetQL, OffsetQLSpecial, M21ObjType
from music19 import spanner
from music19 import tree
from music19.exceptions21 import StreamException, ImmutableStreamException
from music19.stream.iterator import StreamIterator, RecursiveIterator
...
# In [3]: timeit('s = stream.Stream()', setup='from music19 import stream', number=100000)
# Out[3]: 1.6291376419831067

# after adding subclass -- actually faster, showing the rounding error:
# In [2]: timeit('s = stream.Stream()', setup='from music19 import stream', number=100000)
