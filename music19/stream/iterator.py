...
from music19.common.classTools import tempAttribute, saveAttributes
from music19.common.enums import OffsetSpecial
from music19.common.types import M21ObjType, StreamType, ChangedM21ObjType
from music19 import note
from music19.stream import filters
from music19 import prebase
from music19 import base   # just for typing. (but in a bound, so keep here)

from music19.sites import SitesException

if t.TYPE_CHECKING:
    # need to call this streamModule since we have methods named stream.
    from music19 import stream as streamModule
...
class Test(unittest.TestCase):
    ...
    def testAddingFiltersMidRecursiveIteration(self):
        ...
        from music19.stream.iterator import RecursiveIterator as ImportedRecursiveIterator
        m = stream.Measure()
        r = note.Rest()
        n = note.Note()
        m.append([r, n])
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , runTest='testCurrentHierarchyOffsetReset')
