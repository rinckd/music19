...
from music19.common.types import StreamType, OffsetQL
from music19.exceptions21 import StreamException


if t.TYPE_CHECKING:
    from fractions import Fraction
    from music19 import stream
    from music19.stream.iterator import StreamIterator
...
def moveNotesToVoices(source: StreamType,
    ...
    '''
    from music19.stream import Voice
    dst = Voice()
...
def makeAccidentalsInMeasureStream(
    ...
    * Changed in v8: the Stream may have other elements besides measures and the method
        will still work.
    '''
    from music19.stream import Measure, Stream
...
def ornamentalPitches(s: StreamType) -> list[pitch.Pitch]:
    ...
    '''
    from music19.stream import Stream
    post = []
    for e in s.elements:
...
def iterateBeamGroups(
    ...
    >>> from music19.stream.makeNotation import iterateBeamGroups
...
def splitElementsToCompleteTuplets(
    ...
    * New in v8.
    ...
    >>> from music19.stream.makeNotation import splitElementsToCompleteTuplets
    >>> s = stream.Stream(
...
def consolidateCompletedTuplets(
    ...
    * New in v8.
    ...
    >>> from music19.stream.makeNotation import consolidateCompletedTuplets
...
class Test(unittest.TestCase):
    ...
    def testMakeNotationRecursive(self):
        from music19 import stream, tie
