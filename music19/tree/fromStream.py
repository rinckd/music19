...
from music19.common.types import M21ObjType, StreamType
from music19 import common
from music19 import note
from music19.tree import spans
from music19.tree import timespanTree
...
class Test(unittest.TestCase):
    ...
    def testAutoSortExample(self):
        from music19.tree import makeExampleScore
        sc = makeExampleScore()
        sc.sort()
        scTree = asTree(sc)
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , runTest='testAutoSortExample')
