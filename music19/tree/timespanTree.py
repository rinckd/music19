...
if t.TYPE_CHECKING:
    from music19.tree.verticality import Verticality, VerticalitySequence
...
class TimespanTree(trees.OffsetTree):
    ...
    def iterateVerticalitiesNwise(
        ...
        * Changed in v8: added padEnd.  Streams with fewer than n elements
        ...
        '''
        from music19.tree.verticality import VerticalitySequence, Verticality
    ...
    def unwrapVerticalities(verticalities):
        ...
        '''
        from music19.tree.verticality import VerticalitySequence
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , runTest='testGetVerticalityAtWithKey')
