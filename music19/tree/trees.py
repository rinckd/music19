...
from music19.sorting import SortTuple

from music19.tree import core
from music19.tree import node as nodeModule
...
class OffsetTree(ElementTree):
    ...
    def getVerticalityAt(self, offset):
        ...
        '''
        from music19.tree.verticality import Verticality
...
#         from music19 import corpus, note, chord, tree
#         bach = corpus.parse('bwv66.6')
...
if __name__ == '__main__':
    import music19
    music19.mainTest(Test)  # , runTest='testElementsStoppingAt')
